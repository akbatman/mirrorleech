    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/GKBotz">
          <h2 class="name">Bittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.instagram.com/GKBOTZ"><i class="fab fa-instagram"></i></a>
        <a href="https://t.me/GKBotz"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
<body>
    ...
    <div class="content">
        ...
        <a href="https://telegram.me/GKbotz" style="text-decoration: none;">
